...
- Level: Bold
- Formality: Low
- Vibe: sporty, athletic, energetic clash

## Palette roles

- Ground or large group region: `#F2EFE6`
- Primary title, milestone, or key node: `#66914C`
- Secondary group or supporting node: `#DA9EB7`
...
- Use larger modules, shorter text, and wider gaps so saturated colors do not become noisy. Keep the connector network especially sparse.
